...
def coriolis_parameter(lat_degrees):
    ...
    f  = 2 * 7.2921e-5 * np.sin(lat_degrees)
    return f
...
def rh_700(ds):
   ...
   # Extract the pressure, geopotential height, and wind variables
    ...
    rh_levels = [0,1,2,3,5,10,15,20,25,30,40,50,60,65,70,75,80,85,90,95,99,100]
...
def vort_500(ds):
   ...
   # Extract the pressure, geopotential height, and wind variables
    ...
    vort_levels = [0,3,6,12,15,18,21,24,27,30, 40, 50,60,85]
    vort_contours = plt.contourf(to_np(lons), to_np(lats), to_np(abs_vort_500),
                                 levels=vort_levels,
                                 #cmap=get_cmap("BrBG"),
                                 transform=crs.PlateCarree())
